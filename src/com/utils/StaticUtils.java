...
public class StaticUtils {
	...
	public static void setEditTextHintFont(EditText mEditText,
		...
		case 1:
			...
			break;
		case 2:
			str = "HelveticaNeueLTStd_65_Medium.otf";
			break;
		case 3:
	...
	public static void setRadioButtonHintFont(RadioButton mEditText,
		...
		Typeface typeFace = Typeface.createFromAsset(mContext.getAssets(),
				"fonts/HelveticaNeueLTStd_Roman_55.otf");
		mEditText.setTypeface(typeFace);
	}
	...
	public static void loadHtmlContent(WebView view, String appendText,
		...
		String s = "<html><head><style type='text/css'>@font-face {font-family: MyFont;src: url('file:///android_asset/fonts/Quicksand_Book.otf')}body {margin:0px;color:"
				+ color
				+ ";font-family: MyFont;font-size: "
				+ textSize
				+ "px;text-align: left;}</style></head><body>"
				+ appendText
				+ "</body></html>";
